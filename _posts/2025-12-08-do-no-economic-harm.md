...
description: "Draft essay on economic humility: why interventionism fails in an emergent, irreducibly complex economy nobody can predict or design."
category: hidden
---
...
Human intervention can cause huge problems when dealing with emergent complex systems. This is due to unpredictable side effects. The deadliest famine in human history was caused, in part, by the hubris of thinking we could [eliminate some birds](https://en.wikipedia.org/wiki/Eliminate_Sparrows_campaign) without thinking of side effects.
...
<hr>
[^1]: [https://ourworldindata.org/extreme-poverty-in-brief](https://ourworldindata.org/extreme-poverty-in-brief)