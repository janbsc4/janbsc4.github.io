...
description: "Use mise to manage Ruby versions and isolated Python environments on macOS."
---
...
Now, I can jump from this website to a Python project without first checking which Ruby or Python my terminal happens to be using. Each project gets what it needs, nice!