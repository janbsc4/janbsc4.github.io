...
I realized that I didn’t learn about supply and demand until university, and only because I studied business administration. Therefore, I think it’s safe to say that a large portion of the supposedly comparatively well-educated German public has never heard of supply and demand. But there are probably hundreds of TikTok videos explaining these econ 101 concepts, like [how prices form with supply and demand]({{ '/price-system-hayek' | relative_url }}). While it might be the key piece of information needed to understand the fundamental problem with price controls, the availablity of that information does not seem to be the problem.
...
Yes, really, that's the email adress.
